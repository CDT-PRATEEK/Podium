                    ...
                    return (
                        ...
                        >
                            <div className="p-6">
                                ...
                                {/* 2. TITLE */}
                                <h3 
                                    className="text-2xl font-bold text-gray-900 dark:text-white mb-3 leading-tight cursor-pointer hover:text-blue-600 dark:hover:!text-blue-400 transition text-fix"
